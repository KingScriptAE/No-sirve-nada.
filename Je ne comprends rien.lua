...
--[[♦KingTeam^0^独家]]
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "🧡欢迎使用King",Icon = "rbxassetid://17894875649",Duration = 5,Callback = bindable,Button1 = "King技术创作❤️",Button2 = "KingScript已经乱杀"})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "💙by King",Icon = "rbxassetid://18139249668",Duration = 3,Callback = bindable,Button1 = "建议进King群玩🐲",Button2 = "感谢支持King🎉"})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "💛新增超多娱乐功能",Icon = "rbxassetid://18139019694",Duration = 3,Callback = bindable,Button1 = "更多未知需要你们探索💘",Button2 = "创造更好的未来💕"})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "🖤King Team",Icon = "rbxassetid://17894875649",Duration = 3,Callback = bindable,Button1 = "支持120个服务器🎃",Button2 = "50个通用 ‍🔥"})
---------------分割线-------------------------------分割线------------------------
repeat task.wait() until game:IsLoaded()
local library = {}
local ToggleUI = false
...
--[[♦KingTeam^0^独家]]
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "🧡欢迎使用King",Icon = "rbxassetid://17894875649",Duration = 5,Callback = bindable,Button1 = "King技术创作❤️",Button2 = "KingScript已经乱杀୧⍤⃝"})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "💙by King",Icon = "rbxassetid://18139249668",Duration = 3,Callback = bindable,Button1 = "建议进King群玩🐲",Button2 = "感谢支持King🎉"})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "KingScprit",Text = "💛新增超多娱乐功能",Icon = "rbxassetid://18139019694",Duration = 3,Callback = bindable,Button1 = "更多未知需要你们探索💘",Button2 = "创造更好的未来💕"})
...
--[[♦KingTeam^0^独家]]
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "😳KingScprit",Text = "🧡欢迎使用King",Icon = "rbxassetid://17894875649",Duration = 1,Callback = bindable,Button1 = "King创作❤️",Button2 = "KingScript已经乱杀💧"})
wait(0.8)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "😏KingScprit",Text = "💙by King",Icon = "rbxassetid://18139249668",Duration = 0.3,Callback = bindable,Button1 = "建议进King群玩💪",Button2 = "感谢支持King🎉"})
wait(0.9)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "🙄KingScprit",Text = "💛新增超多娱乐功能",Icon = "rbxassetid://18139019694",Duration = 0.4,Callback = bindable,Button1 = "更多未知需要你们探索💘",Button2 = "创造更好的未来💕"})
wait(1)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "😊KingScprit",Text = "🖤King Team",Icon = "rbxassetid://17894875649",Duration = 0.5,Callback = bindable,Button1 = "支持120个服务器🎃",Button2 = "50个通用 😘"})
---------------分割线-------------------------------分割线------------------------
repeat task.wait() until game:IsLoaded()
local library = {}
local ToggleUI = false
        ...
        function section:Label(text)
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            funcs.RemoveOption = function(self, option)
              local option = DropdownModule:FindFirstChild("Option_" .. option)
 --[[KingUI.@AL★King独家]]
  game:GetService("StarterGui"):SetCore("SendNotification",{Title = "★King Team",Text = "♦不会跑路",Icon = "rbxassetid://17894875649",Duration = 0.8,Callback = bindable,Button1 = "不会跑路🙄",Button2 = "不会跑路❤️"})
 wait(1)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "★King Team",Text = "♦不会跑路",Icon = "rbxassetid://18139019694",Duration = 0.8,Callback = bindable,Button1 = "不会跑路🙄",Button2 = "不会跑路😳"})
wait(2)
 ...
 wait(2.1)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "★King Team",Text = "♦by King",Icon = "rbxassetid://18139019694",Duration = 1.2,Callback = bindable,Button1 = "更多未知需要你们探索😊",Button2 = "未来等待着你😳"})
wait(2)
