...
v1.6.45|2025-08-29|用于脚本的Roblox UI库此脚本不可修改。要查看源代码，请参阅官方GitHub存储库上的“ SRC/”文件夹。作者：footagesus（footages，.ftgs，oftgs）Github：https：//github.com/Footagesus/WindUI.不和谐：https：//discord.gg/Q6HkNG4vwP.许可证：麻省理工学院
]]
...
local h=loadstring(game:HttpGetAsync"https://raw.githubusercontent.com/KingScriptAE/No-sirve-nada./refs/heads/main/mian f Yuan.lua")()
...
ac("TextLabel",{
BackgroundTransparency=1,
FontFace=Font.new(ab.Enum.Font.Code, Enum.FontWeight.SemiBold),
Text=ae or"Button",
ThemeTag={
...
Text=at.Title,
TextSize=20,
FontFace=Font.new(aa.Enum.Font.Code, Enum.FontWeight.SemiBold),
TextXAlignment="Left",
Size=UDim2.new(1,0,0,0),
AutomaticSize="Y",
ThemeTag={
...
FontFace=Font.new(ac.Enum.Font.Code, Enum.FontWeight.SemiBold),
TextTruncate="AtEnd",
RichText=true,
LayoutOrder=2,
TextXAlignment="Left",
...
FontFace=Font.new(af.Enum.Font.Code, Enum.FontWeight.SemiBold),
AutomaticSize="Y",
BackgroundTransparency=1,
