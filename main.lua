...
ac("TextLabel",{
BackgroundTransparency=1,
FontFace=Font.new(ab.Font,Enum.Font.LuckiestGuy),
Text=ae or"Button",
ThemeTag={
...
Text=at.Title,
TextSize=20,
FontFace=Font.new(aa.Font,Enum.Font.LuckiestGuy),
TextXAlignment="Left",
Size=UDim2.new(1,0,0,0),
AutomaticSize="Y",
ThemeTag={
...
FontFace=Font.new(ac.Font,Enum.Font.LuckiestGuy),
TextTruncate="AtEnd",
RichText=true,
LayoutOrder=2,
TextXAlignment="Left",
...
FontFace=Font.new(af.Font,Enum.Font.LuckiestGuy),
AutomaticSize="Y",
BackgroundTransparency=1,
