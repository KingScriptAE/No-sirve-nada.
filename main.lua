...
local K=w and"提示 "..p.ToggleKey.Name.." 打开ui"or"单击按钮打开ui"
...
function p.EditOpenButton(K, L)
    if y and y.Parent ~= nil then
        local M = {
            Title = L.Title or p.Title,
            Icon = L.Icon or p.Icon,
            Enabled = L.Enabled ~= false,
            Position = L.Position or UDim2.new(0.5, 0, 0, 40),
            Draggable = L.Draggable ~= false,
            OnlyMobile = L.OnlyMobile or false,
            CornerRadius = L.CornerRadius or UDim.new(1, 0),
            StrokeThickness = L.StrokeThickness or 2,
            Color = L.Color or ColorSequence.new(Color3.fromHex("#404040"), Color3.fromHex("#808080")),
            BackgroundTransparency = L.BackgroundTransparency or 0.8,
            Size = L.Size or UDim2.new(0, 120, 0, 36)
        }
        ...
        y.Size = M.Size
        y.TextButton.Size = UDim2.new(1, -8, 1, -8)
        y.UICorner.CornerRadius = UDim.new(1, 0)
        y.TextButton.UICorner.CornerRadius = UDim.new(1, 0)

        y.BackgroundTransparency = M.BackgroundTransparency
        ...
        local isMobile = aa.TouchEnabled and not aa.KeyboardEnabled
        y.Visible = not M.OnlyMobile or isMobile

        if M.Icon and z then
        ...
        if OpenButtonTitle then
            ...
            OpenButtonTitle.Visible = true
        end

        if y.UIStroke and y.UIStroke.UIGradient then
        ...
        if OpenButtonDrag and OpenButtonDivider then
            OpenButtonDrag.Visible = false
            OpenButtonDivider.Visible = false
        end
    end
end
