...
local Library = {
    ...
    Scheme = {
        ...
        AccentColor = Color3.fromRGB(90, 110, 230), 
        OutlineColor = Color3.fromRGB(10, 10, 15), 
...
local Templates = {
    ...
    TextBox = {
        ...
        PlaceholderColor3 = function()
            ...
            return Color3.fromHSV(H, S, V / 2.5)
        end,
        Text = "",
        TextColor3 = "FontColor",
    },
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        New("UICorner", {CornerRadius = UDim.new(0,4), Parent = HueBox})
        ...
        New("UICorner", {CornerRadius = UDim.new(0,4), Parent = RgbBox})
...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        local MobileHandle = New("Frame", {
            Size = UDim2.fromOffset(100, 44),
            Position = UDim2.new(0.5, -50, 0.1, 0),
            BackgroundColor3 = Library.Scheme.MainColor,
            Parent = ScreenGui,
            Active = true
        })
        New("UICorner", { CornerRadius = UDim.new(1, 0), Parent = MobileHandle })
        
        local MobileGradient = New("UIGradient", {
            Color = ColorSequence.new({
        ...
        LockBtn.MouseButton1Click:Connect(function()
            ...
            LockBtn.ImageColor3 = Library.CantDragForced and Library.Scheme.Red or Library.Scheme.FontColor
            LockBtn.Image = Library.CantDragForced and "rbxassetid://6031082536" or "rbxassetid://6031082533"
        end)
        
        Library:MakeDraggable(MobileHandle, MobileHandle, true)
    end
